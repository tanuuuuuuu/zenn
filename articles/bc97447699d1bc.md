...
:::message
利用するには、まず初めにセマンティックレイヤーを定義する必要があります。

Steep は、自身のネイティブなセマンティックレイヤーに加えて、dbt Semantic Layer や Cube といったサードパーティ製のセマンティックレイヤーサービスを利用することができます。
:::

Steep の最大の特徴は、無駄な機能が削ぎ落とされ、圧倒的に洗練されている UI/UX です。チャートの種類も、棒グラフ、折れ線グラフ、ランクチャート、ピボットテーブルなど、基本的なものに絞られています。
